...
public class Main {
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		myMedicalController.addPatient(new Client("1", "Daniele Land","landiFiscalCode","landiResidence","landiPhone","landiEmail"/*,"landiHappyDay"*/));
		System.out.println("Adding a patient...");
		myMedicalController.addPatient(new Client("2", "Daniel Zanchi","zanchiFiscalCode","zanchiResidence","zanchiPhone","zanchiEmail"/*,"zanchiHappyDay"*/));
